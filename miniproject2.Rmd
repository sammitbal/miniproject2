...
**Step 3: Interpret:** As a person’s [insert VAR] increases by 1 [insert UNIT], we expect the odds of [insert SUCCESS] to change by a factor of [insert FACTOR (ODDS)].
...
```{r}
# A glimpse at Score (REMOVE THIS ONCE READ)
COD_dataset %>%
  select(Score) %>%
