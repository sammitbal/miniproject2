...
3.1. *If a variable is categorical...*
...
3.2. *If a variable is quantitative...*
...
5. Place each discussion next to the relevant plot/summary statistics rather than writing code for all 5 variables first followed by all discussion. If you the discussions are not near the plots, it makes it difficult for your audience to follow your explanations without excessive scrolling
