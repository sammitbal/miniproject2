...
As expected, most players that were surveyed played full games. For the players that played partial games, we are still unsure at what point they joined the game. Whether that be in the beginning, middle, or end of the game. We can only make an inference based on their eliminations/deaths/score from that game played on when they could have joined the match. 
...
**Our Group's Question:** (Reword this, but this is the gist of the question) "Is the score related to the result (win/loss)?" 
...
As a teams score increases by 1 point, we expect the odds of winning to change by a factor of 1.000169.
